	...
	<div id="wrapper">
		...
		<nav id="menu">
			<ul class="links">
				...
				<li> <a href="<?php echo base_url('index.php/car') ?>">Search Car</a> </li>

				<li> <a href="<?php echo base_url('index.php/Index/about') ?>">About Us</a> </li>

				<li class="active"> <a href="<?php echo base_url('index.php/Index/blog') ?>">Blog</a> </li>
		...
		<div id="main" class="alt">
			...
			<section id="one">
				<div class="inner">
					...
					<span class="image main"><img src="<?php echo base_url(); ?>images/blog-fullscreen-1-1920x700.jpg" alt="" /></span>
